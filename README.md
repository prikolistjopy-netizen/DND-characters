...
- Class Anchor, Cultural Origin, Narrative Motif, and Narrative Variant layers preserve class readability while adding story details, theme variants, cultural flavor, and prompt fragments.
...
The debug check compiles the generator into a temporary CommonJS folder, generates 5000 seeds, prints class identity/theme/culture diversity statistics, and fails if any hierarchical identity, diversity, or coherence rule is violated.
