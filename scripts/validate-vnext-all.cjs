...
const scripts = ['validate-vnext-data.cjs','semantic-vnext-analysis.cjs','semantic-rule-comparison.cjs','semantic-incremental-analysis.cjs','semantic-situation-analysis.cjs','visual-director-vnext-analysis.cjs','prompt-compiler-vnext-analysis.cjs','semantic-legacy-comparison.cjs','visual-vnext-repetition-analysis.cjs','runtime-vnext-generation-check.cjs','semantic-seed-intelligence-analysis.cjs','semantic-anchor-diversity-analysis.cjs','environment-power-diversity-analysis.cjs'];
