...
export const dreamWalkerCompatibilityAliases: Record<string, string[]> = {
  ritualist: ['arcane_caster'],
  mystic_support: ['arcane_caster', 'divine_scholar'],
  support_caster: ['arcane_caster', 'divine_scholar'],
  occult_guide: ['arcane_caster'],
  exorcist: ['holy_warrior', 'divine_scholar'],
  performer: ['skald_performer', 'lorekeeper_bard'],
  skirmisher: ['shadow_skirmisher'],
  occult_knight: ['holy_warrior', 'arcane_caster'],
  wandering_healer: ['holy_warrior'],
  defensive_tank: ['holy_warrior', 'martial_veteran'],
  occult_hunter: ['shadow_skirmisher', 'frontier_hunter'],
  fey_touched: ['fey_trickster'],
  scholar: ['arcane_caster', 'divine_scholar', 'lorekeeper_bard'],
  scout: ['frontier_hunter', 'shadow_skirmisher'],
  wanderer: ['frontier_hunter', 'fey_trickster', 'skald_performer'],
};

export const dreamWalkerRejectedCompatibilityTags: string[] = [];
...
export const classAnchors: ClassAnchor[] = [
  ...
  { className: 'fighter', label: 'Fighter Martial Identity', weaponTags: ['martial', 'shield', 'greatsword', 'spear', 'handaxe', 'warhammer', 'dual-blades', 'mace', 'bow'], armorTags: ['light', 'medium', 'heavy', 'metal'], poseTags: ['shield', 'heavy-melee', 'dual-blades', 'general', 'bow'], detailKeywords: ['veteran', 'guard', 'arena', 'banner', 'combat', 'campaign'] },
...
export const curatedMulticlassProfiles: CuratedMulticlassProfile[] = [
  ...
  { id: 'shadow_monastery_adept', label: 'Shadow Monastery Adept', primaryClass: 'monk', secondaryClass: 'rogue', buildTemplateId: 'wandering_martial_artist', fantasyPillarId: 'warrior', compatibleThemes: ['silent_avenger', 'temple_guardian', 'wandering_master', 'dragon_style_adept'], preferredThemes: ['silent_avenger'], visualFantasy: 'a silent martial artist trained to strike from temple shadows', promptHint: 'monk wraps and martial pose remain primary with hidden knife discipline', weight: 5 },
  ...
  { id: 'prayer_fist_guardian', label: 'Prayer-Fist Guardian', primaryClass: 'monk', secondaryClass: 'cleric', buildTemplateId: 'wandering_martial_artist', fantasyPillarId: 'divine', compatibleThemes: ['temple_guardian', 'wandering_master', 'dragon_style_adept', 'mountain_hermit'], preferredThemes: ['temple_guardian'], visualFantasy: 'a sacred martial artist whose prayers move through disciplined strikes', promptHint: 'monk silhouette and wraps stay primary with holy beads and temple light', weight: 6 },
...
export const armors: Array<WeightedOption<ArmorOption>> = [
  ...
  { name: 'moon-thread sleep robes', tags: ['cloth'], weight: 5 },
  { name: 'sleep-warded travel cloak', tags: ['cloth'], weight: 5 },
  { name: 'padded dream shawl over soft robes', tags: ['cloth'], weight: 4 },
];
...
export const weapons: Array<WeightedOption<WeaponOption>> = [
  ...
  { name: 'unreadable dream journal focus', tags: ['book', 'spellbook', 'magic-focus', 'focus'], weight: 5 },
  { name: 'silver sleep lantern focus', tags: ['tool', 'magic-focus', 'focus', 'lantern'], weight: 5 },
  { name: 'moon glass dream vial focus', tags: ['orb', 'magic-focus', 'focus'], weight: 4 },
  { name: 'sleep-warded charm cord', tags: ['tool', 'magic-focus', 'focus'], weight: 4 },
...
export const poses: Array<WeightedOption<PoseOption>> = [
  { name: 'ready stance on a cracked dungeon tile', tags: ['general'], weight: 2 },
  ...
  { name: 'shield braced against incoming sparks', tags: ['shield'], weight: 2 },
  ...
  { name: 'casting with both hands in a spiral gesture', tags: ['casting'], weight: 3 },
  { name: 'tracing a glowing sigil in the air', tags: ['casting'], weight: 2 },
  ...
  { name: 'flying kick with prayer beads suspended midair', tags: ['monk'], weight: 2 },
  { name: 'standing calmly with weapon lowered', tags: ['general', 'calm_presence'], weight: 7 },
  { name: 'staff planted on the ground', tags: ['staff', 'casting', 'calm_presence'], weight: 7 },
  { name: 'resting one hand on weapon pommel', tags: ['general', 'weapon_display'], weight: 7 },
  { name: 'cloak held against wind', tags: ['general', 'travel_presence'], weight: 6 },
  { name: 'holding an instrument at rest', tags: ['performance', 'calm_presence'], weight: 8 },
  { name: 'speaking a spell softly', tags: ['casting', 'casting_subtle'], weight: 8 },
  { name: 'bow held lowered after tracking', tags: ['bow', 'tracking', 'travel_presence'], weight: 7 },
  { name: 'one hand extended in subtle magic, not full sigil', tags: ['casting', 'casting_subtle'], weight: 7 },
  { name: 'book held closed under one arm', tags: ['casting', 'calm_presence'], weight: 6 },
  { name: 'quiet storytelling stance with one hand raised', tags: ['performance', 'social_character_pose'], weight: 7 },
  { name: 'courtly flourish with rapier lowered', tags: ['performance', 'rapier', 'social_character_pose'], weight: 7 },
  { name: 'protective stance with shield lowered', tags: ['shield', 'guarded_stance'], weight: 7 },
  { name: 'dagger half-drawn under cloak', tags: ['dual-blades', 'stealth_motion'], weight: 7 },
  { name: 'hands wrapped, ready but not jumping', tags: ['monk', 'calm_presence'], weight: 7 },
  { name: 'calm three-quarter stance', tags: ['general', 'calm_presence'], weight: 8 },
  { name: 'standing with cloak held by wind', tags: ['general', 'travel_presence'], weight: 7 },
  { name: 'weapon grounded beside the character', tags: ['general', 'weapon_display'], weight: 7 },
  { name: 'looking down with quiet authority', tags: ['general', 'calm_presence'], weight: 6 },
  { name: 'walking forward with weapon lowered', tags: ['general', 'travel_presence'], weight: 7 },
  { name: 'turning slightly as cloak moves', tags: ['general', 'travel_presence'], weight: 7 },
  { name: 'adjusting a glove or bracer', tags: ['general', 'calm_presence'], weight: 6 },
  { name: 'checking blade edge', tags: ['general', 'weapon_display'], weight: 6 },
  { name: 'holding a focus close to the chest', tags: ['casting', 'casting_subtle'], weight: 7 },
  { name: 'holding orb close with one hand', tags: ['casting', 'casting_subtle'], weight: 7 },
  { name: 'controlled one-handed spell gesture', tags: ['casting', 'casting_subtle'], weight: 7 },
  { name: 'standing calmly with focus lowered', tags: ['casting', 'calm_presence'], weight: 7 },
  { name: 'mid-song gesture', tags: ['performance', 'social_character_pose'], weight: 7 },
  { name: 'storytelling gesture', tags: ['performance', 'social_character_pose'], weight: 7 },
  { name: 'rapier lowered in courtly stance', tags: ['rapier', 'performance', 'social_character_pose'], weight: 7 },
  { name: 'holy symbol held close, not raised dramatically', tags: ['prayer', 'calm_presence'], weight: 6 },
  { name: 'standing after battle, weapon at rest', tags: ['general', 'calm_presence'], weight: 7 },
  { name: 'travel-ready stance with cloak and boots emphasized', tags: ['general', 'travel_presence'], weight: 7 },
  ...
  { name: 'holding a silver sleep lantern at chest height', tags: ['tools', 'casting'], weight: 4 },
  { name: 'touching a sleep mask while listening inward', tags: ['casting'], weight: 4 },
  { name: 'tracing abstract dream glyphs over an unreadable journal', tags: ['casting', 'tools'], weight: 4 },
  { name: 'pouring moonlight from a dream vial', tags: ['casting', 'tools'], weight: 3 },
  { name: 'standing half-awake as moon-thread charms drift', tags: ['casting'], weight: 3 },
];
...
export const moods: Array<WeightedOption<MoodOption>> = [
  ...
  { name: 'soft oneiric focus', tags: ['mage', 'scholar'], weight: 5 },
  { name: 'sleep-warded calm', tags: ['mage', 'cursed'], weight: 5 },
  { name: 'nightmare kept at bay', tags: ['cursed', 'mage'], weight: 3 },
...
export const lights: Array<WeightedOption<LightOption>> = [
  ...
  { name: 'moonlight through half-closed curtains', tags: ['mage'], weight: 5 },
  { name: 'silver bedside candle glow', tags: ['mage', 'scholar'], weight: 5 },
  { name: 'pale dawn after a dream', tags: ['mage'], weight: 4 },
...
export const effects: Array<WeightedOption<FxOption>> = [
  ...
  { name: 'soft dream motes', tags: ['mage'], weight: 5 },
  { name: 'moonlit sleep haze', tags: ['mage'], weight: 5 },
  { name: 'abstract dream glyphs', tags: ['mage', 'scholar'], weight: 4 },
  { name: 'faint nightmare threads', tags: ['cursed', 'mage'], weight: 2 },
];
...
export const visualThemes: Array<WeightedOption<VisualTheme>> = [
  ...
  {
    id: 'dream_walker', label: 'Dream Walker', buildTemplateId: 'arcane_caster', archetypeTags: ['mage', 'scholar', 'cursed'], archetypeNames: ['arcane academy dropout', 'cursed cartographer'],
    preferredMoods: ['soft oneiric focus', 'sleep-warded calm', 'nightmare kept at bay'], preferredLights: ['moonlight through half-closed curtains', 'silver bedside candle glow', 'pale dawn after a dream'], preferredFx: ['soft dream motes', 'moonlit sleep haze', 'abstract dream glyphs', 'faint nightmare threads'],
    preferredWeapons: ['unreadable dream journal focus', 'silver sleep lantern focus', 'moon glass dream vial focus', 'weathered spellbook'], preferredArmor: ['moon-thread sleep robes', 'sleep-warded travel cloak', 'padded dream shawl over soft robes'], preferredPoses: ['holding a silver sleep lantern at chest height', 'touching a sleep mask while listening inward', 'tracing abstract dream glyphs over an unreadable journal'], preferredSilhouettes: ['dream_pilgrim', 'sleep_warder_profile', 'moonlit_somnambulist'],
    fantasyPillarId: 'mystic', visualFantasy: 'Looks like someone who walks safely through dreams and brings back soft moonlit omens.', visualMotifIds: ['dream_motif', 'eclipse_motif'], detailPoolIds: ['dream_walker'], armorLanguageIds: ['dreamwalker_sleep_robes', 'sleep_warded_cloak'], weaponLanguageIds: ['dream_journal_focus', 'sleep_lantern_focus', 'moon_vial_focus'],
    visualDetails: ['unreadable dream journal', 'moon-thread bracelets', 'sleep ward charms'], weight: 6,
  },
  {
...
const explicitVisualThemeVariants: Record<string, VariantSeed[]> = {
  ...
  dream_walker: [
    { id: 'lucid_sleepwalker', label: 'Lucid Sleepwalker', visualDetails: ['silver sleep mask tied to the belt', 'moon-thread bracelet at the wrist', 'unreadable dream notes tucked into the sash'], promptFragments: ['keeps the dream-walker grounded and lucid'], preferredFx: ['soft dream motes', 'moonlit sleep haze'], weight: 8 },
    { id: 'sleep_ward_keeper', label: 'Sleep Ward Keeper', visualDetails: ['sleep ward charm pinned to the cloak', 'blue thread knots around the focus', 'small moon glass vial fastened to a cord'], promptFragments: ['protects sleepers with quiet moonlit wards'], preferredFx: ['abstract dream glyphs', 'soft dream motes'], weight: 8 },
    { id: 'nightmare_listener', label: 'Nightmare Listener', visualDetails: ['dark thread at the cuff', 'faint under-eye shadows', 'sealed nightmare bead on a cord'], promptFragments: ['carries a rare nightmare-tinged but restrained dream variant'], preferredFx: ['faint nightmare threads', 'moonlit sleep haze'], weight: 3 },
  ],
  archive_performer: [
...
export const visualMotifs: VisualMotif[] = [
  ...
  { id: 'dream_motif', label: 'Dream Motif', compatibleThemes: ['dream_walker'], compatibleBuildTemplates: ['arcane_caster'], shapes: ['soft crescent loops', 'closed-eye symbols', 'rippled moon circles'], materials: ['moon glass', 'silver thread', 'pale silk'], ornamentDetails: ['closed-eye charm sewn into the cloak', 'silver dream knots on the cuffs', 'moon-glass beads around the focus'], promptFragments: ['soft closed-eye motif', 'moon-glass beadwork', 'silver thread dream knots'] },
...
export const armorLanguages: ArmorLanguage[] = [
  ...
  { id: 'dreamwalker_sleep_robes', label: 'Dreamwalker Sleep Robes', armorCategory: ['cloth', 'none'], compatibleBuildTemplates: ['arcane_caster'], compatibleThemes: ['dream_walker'], promptFragments: ['soft moon-thread sleep robes', 'closed-eye embroidery', 'sleep-warded cuffs'], detailHints: ['closed-eye embroidery', 'sleep-warded cuffs'] },
  { id: 'sleep_warded_cloak', label: 'Sleep-Warded Cloak', armorCategory: ['cloth', 'light'], compatibleBuildTemplates: ['arcane_caster'], compatibleThemes: ['dream_walker'], promptFragments: ['sleep-warded travel cloak', 'moonlit lining', 'tiny dream knots along the hem'], detailHints: ['moonlit cloak lining', 'dream knots'] },
  ...
  { id: 'fallen_saint_plate', label: 'Fallen Saint Plate', armorCategory: ['heavy', 'metal'], compatibleBuildTemplates: ['holy_warrior'], compatibleThemes: ['fallen_saint', 'grave_warden', 'battle_chaplain', 'wandering_healer', 'sun_knight'], promptFragments: ['darkened saintly plate', 'scratched halo motifs', 'cracked sacred trim'], detailHints: ['scratched halo motifs', 'cracked sacred trim'] },
...
export const weaponLanguages: WeaponLanguage[] = [
  ...
  { id: 'dream_journal_focus', label: 'Dream Journal Focus', baseWeaponTags: ['book', 'spellbook'], compatibleBuildTemplates: ['arcane_caster'], compatibleThemes: ['dream_walker'], promptFragments: ['unreadable dream journal with abstract sleep marks', 'moon-thread bookmark cords'], detailHints: ['unreadable dream journal', 'abstract sleep marks'] },
  { id: 'sleep_lantern_focus', label: 'Sleep Lantern Focus', baseWeaponTags: ['lantern', 'tool', 'focus'], compatibleBuildTemplates: ['arcane_caster'], compatibleThemes: ['dream_walker'], promptFragments: ['silver sleep lantern with dim moonlit glass', 'soft ward light inside the lantern'], detailHints: ['silver sleep lantern', 'dim moonlit glass'] },
  { id: 'moon_vial_focus', label: 'Moon Vial Focus', baseWeaponTags: ['orb', 'focus'], compatibleBuildTemplates: ['arcane_caster'], compatibleThemes: ['dream_walker'], promptFragments: ['moon glass dream vial focus', 'pale liquid starlight sealed inside'], detailHints: ['moon glass dream vial', 'sealed pale starlight'] },
  ...
  { id: 'battle_mage_staff', label: 'Battle Mage Staff', baseWeaponTags: ['staff', 'wand'], compatibleBuildTemplates: ['arcane_caster'], compatibleThemes: ['battle_mage', 'ritualist', 'academy_mage', 'dream_walker'], promptFragments: ['reinforced battle casting staff', 'scorched grip bands', 'impact-worn focus cap'], detailHints: ['scorched grip bands', 'reinforced focus cap'] },
...
export const equipmentFinishes: EquipmentFinish[] = [
  { id: 'sleep_warded', label: 'Sleep-Warded', compatibleBuildTemplates: ['arcane_caster'], compatibleThemes: ['dream_walker'], compatiblePillars: ['mystic', 'scholar'], compatibleArmorLanguages: ['dreamwalker_sleep_robes', 'sleep_warded_cloak'], compatibleWeaponLanguages: ['dream_journal_focus', 'sleep_lantern_focus', 'moon_vial_focus'], promptFragments: ['soft sleep-warded finish', 'moon-thread bindings', 'quiet protective stitchwork'], detailHints: ['moon-thread bindings', 'sleep-warded stitchwork'], weight: 9 },
  { id: 'moonlit_worn', label: 'Moonlit Worn', compatibleBuildTemplates: ['arcane_caster'], compatibleThemes: ['dream_walker', 'star_seer'], compatiblePillars: ['mystic', 'scholar'], compatibleArmorLanguages: ['dreamwalker_sleep_robes', 'scholar_travel_robes'], compatibleWeaponLanguages: ['dream_journal_focus', 'starseer_crystal_focus'], promptFragments: ['soft moon-worn surfaces', 'silvered edges from long nights', 'gentle nocturnal patina'], detailHints: ['silvered moon-worn edges'], weight: 7 },
...
export const silhouetteProfiles: SilhouetteProfile[] = [
  ...
  makeSilhouette('sleep_warder_profile', 'Sleep Warder Profile', 'caster', ['arcane_caster'], ['dream_walker'], ['small', 'medium', 'large'], 'quiet caster silhouette with a lantern, sleep charms, and soft robe layers'),
  makeSilhouette('moonlit_somnambulist', 'Moonlit Somnambulist', 'asymmetrical', ['arcane_caster'], ['dream_walker'], ['small', 'medium', 'large'], 'slightly off-balance dreamwalker silhouette with drifting moon-thread ribbons'),
...
export const themeContentProfiles: ThemeContentProfile[] = [
  ...
  { themeId: 'dream_walker', heroDetails: ['silver sleep mask', 'unreadable dream journal', 'moon-thread bracelets', 'glass dream vials', 'pale sleepless complexion', 'soft glowing eyelids', 'sleep ward charm cord', 'moonlit mist ribbons', 'unfinished abstract dream sketches', 'lucid dreaming notes with illegible marks', 'closed-eye cloak clasp', 'silver bedside candle stub', 'blue thread knots around the wrist', 'moon glass bead string', 'sleep-warded sash'], rareDetails: ['floating dream fragments', 'half-transparent memories', 'sleep sigils', 'moonlit reflections around the body', 'dreamcatcher chains', 'bottle of captured dreams', 'tiny moth-wing sleep charm', 'sealed nightmare bead'], legendaryDetails: ['sleeping spirit silhouette following behind', 'living dream butterflies', 'fractured reality reflections', 'dream serpent coiling through the air', 'miniature moonlit door behind the head'], storyProps: ['unreadable dream journal carried close', 'memory bottle tied to the belt', 'unfinished dream map with abstract marks', 'sleep ward talismans', 'silver pillow charm'], faceDetails: ['soft glowing eyelids', 'pale sleepless complexion', 'faint crescent under-eye mark'], handDetails: ['blue thread knots around the fingers', 'moon-glass ring', 'sleep sigils on the knuckles'], cloakDetails: ['moon-thread hem', 'closed-eye cloak clasp', 'sleep ward stitches'], beltDetails: ['dream vial belt loop', 'silver sleep mask tied to the belt', 'unreadable notes tucked into the sash'], jewelryDetails: ['moon-thread bracelet', 'moon glass bead string', 'tiny moth-wing charm'], backgroundProps: ['single soft bed-curtain silhouette', 'distant crescent window reflection'], companionCompatibleDetails: ['sleep charm on companion collar', 'moon-thread tied to companion harness'] },
...
export const buildTemplates: Array<WeightedOption<BuildTemplate>> = [
  {
    ...
    allowedArmor: ['embroidered arcane robes', 'travel-worn cloth layers', 'plain monastery cloth', 'moon-thread sleep robes', 'sleep-warded travel cloak', 'padded dream shawl over soft robes'],
    allowedWeapons: ['oak spell staff', 'crystal orb focus', 'silver wand focus', 'weathered spellbook', 'scroll case and compass', 'crystal focus', 'floating spellbook', 'brass astrolabe', 'bone-carved wand', 'ink-stained grimoire', 'celestial chart cylinder', 'unreadable dream journal focus', 'silver sleep lantern focus', 'moon glass dream vial focus', 'sleep-warded charm cord'],
    allowedPoses: ['casting with both hands in a spiral gesture', 'tracing a glowing sigil in the air', 'studying a map under candlelight', 'ritual prep around carefully arranged instruments', 'ready stance on a cracked dungeon tile', 'staff planted on the ground', 'speaking a spell softly', 'one hand extended in subtle magic, not full sigil', 'book held closed under one arm', 'adjusting floating pages', 'drawing a sigil circle', 'consulting star charts', 'turning a brass astrolabe toward the light', 'opening a floating grimoire mid-spell', 'holding a silver sleep lantern at chest height', 'touching a sleep mask while listening inward', 'tracing abstract dream glyphs over an unreadable journal', 'pouring moonlight from a dream vial', 'standing half-awake as moon-thread charms drift'],
    allowedSilhouettes: ['tall robed column', 'asymmetrical cloak profile', 'lean and sharp-edged', 'compact and nimble'],
    allowedMoods: ['arcane study wonder', 'void-cursed omen', 'haunted midnight ritual', 'soft oneiric focus', 'sleep-warded calm', 'nightmare kept at bay'],
    allowedLights: ['blue arcane glyph light', 'cold moon rim light', 'void glow from below', 'candlelit map glow', 'moonlight through half-closed curtains', 'silver bedside candle glow', 'pale dawn after a dream'],
    allowedFx: ['subtle magical runes', 'purple void energy', 'black-violet motes', 'map glow lines', 'drifting void ash', 'black-violet sparks', 'gravity distortions', 'fragmented stars', 'paper glyph flutter', 'ink sparks', 'soft dream motes', 'moonlit sleep haze', 'abstract dream glyphs', 'faint nightmare threads'],
  ...
  },
  {
    ...
    allowedPoses: ['shield braced against incoming sparks', 'guarded stance behind a raised shield', 'protective stance with shield lowered', 'weapon raised in a decisive challenge', 'kneeling prayer as holy light gathers', 'casting with both hands in a spiral gesture', 'ready stance on a cracked dungeon tile', 'raising a relic censer in prayer', 'planting a banner spear before the charge', 'guarding behind a reliquary shield', 'blessing a pilgrim staff before battle', 'swinging a sun-forged mace in a warding arc'],
  ...
  },
  {
    ...
    allowedFx: ['swirling mist', 'wet cobblestone haze', 'black-violet motes', 'subtle magical runes', 'map glow lines', 'drifting void ash', 'black-violet sparks', 'paper glyph flutter', 'ink sparks', 'soft dream motes', 'moonlit sleep haze', 'abstract dream glyphs', 'faint nightmare threads'],
  ...
  },
  {
    ...
    allowedPoses: ['performing a playful fey flourish', 'holding an instrument at rest', 'quiet storytelling stance with one hand raised', 'courtly flourish with rapier lowered', 'turning mid-stride as cloak whips around', 'weapon raised in a decisive challenge', 'duelist turn with one foot sliding back', 'ready stance on a cracked dungeon tile', 'performing before an unseen audience', 'writing notes into a songbook', 'tuning a magical instrument', 'unfurling a memory scroll mid-song', 'striking a rune-carved lute chord'],
  ...
  },
  {
    ...
    allowedPoses: ['performing a playful fey flourish', 'holding an instrument at rest', 'quiet storytelling stance with one hand raised', 'courtly flourish with rapier lowered', 'ritual prep around carefully arranged instruments', 'duelist turn with one foot sliding back', 'turning mid-stride as cloak whips around', 'performing before an unseen audience', 'writing notes into a songbook', 'tuning a magical instrument', 'unfurling a memory scroll mid-song', 'striking a rune-carved lute chord'],
  ...
  },
  {
    ...
    allowedPoses: ['aiming down a rain-darkened arrow', 'drawing a bowstring with held breath', 'bow held lowered after tracking', 'tracking footprints with cloak pulled low', 'ready stance on a cracked dungeon tile', 'turning mid-stride as cloak whips around', 'studying a map under candlelight', 'ritual prep around carefully arranged instruments', 'inspecting tracks with a lantern low', 'preparing a hunting trap', 'listening to distant sounds with horn lowered', 'bracing a hunting spear in tall grass', 'drawing a bone bow at dusk'],
