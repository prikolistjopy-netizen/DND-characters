...
const paths = [
  {
    ...
    description: 'One roll. A complete cinematic character, ready to copy or refine.',
    cta: 'Quick Roll',
  ...
  },
  {
    ...
    description: 'Guide race, class, identity, and tone before Diceborn resolves the scene.',
    cta: 'Build Character',
    ...
    <>
      ...
      <section className="landing-section path-section" aria-labelledby="paths-title">
        <div className="section-heading">
          ...
          <h2 id="paths-title">Fate can speak first. You can answer.</h2>
        </div>
      ...
      <section id="how-it-works" className="landing-section how-section" aria-labelledby="how-title">
        <div className="section-heading">
          ...
          <h2 id="how-title">A quiet director behind the roll.</h2>
        </div>
      ...
      <section className="landing-section featured-section" aria-labelledby="featured-title">
        <div className="section-heading">
          ...
          <h2 id="featured-title">Four silhouettes, four doors into the tone.</h2>
        </div>
      ...
      <section className="final-cta" aria-labelledby="cta-title">
        ...
        <p className="final-cta__lede">Create a character and see where the roll leads.</p>
