import { generateCharacterSeed, resetSmartCandidatePoolMemory } from '../../src/lib/generator';
import { generateDicebornVNext } from '../../src/lib/vnext/generateVNext';
...
function legacyPromptFor(item: ComparisonCase): string {
  try {
    const result = generateCharacterSeed({
      ...
      rngSeed: item.seed,
    } as never) as unknown as { dicebornResult?: { imagePrompt?: string } };
...
export const metadata = {
  title: 'vNext comparison',
  description: 'Internal Legacy and Semantic vNext comparison for Diceborn.',
};
